...
interface Project {
  ...
  title: string;
  category?: string;
  description?: string; // Corrected from 'description' to 'summary' based on API usage in original
  demo_url?: string;
  tech_stack?: string[];
}
    ...
    <section id="portfolio" className="py-24 bg-slate-900/50">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          ...
          <a
            href="#"
            className="text-primary hover:text-white font-medium flex items-center gap-2 transition-colors"
          >
